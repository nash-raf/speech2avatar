...
from generator.dataset import AudioMotionSmirkGazeDataset, generator_collate_fn
...
class System(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        opt = optim.Adam(trainable_params, lr=self.opt.lr, betas=(0.5, 0.999))
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--dataset_path", "--dataset_pat", dest="dataset_path", required=True, type=str)
