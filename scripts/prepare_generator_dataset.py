...
def parse_args():
    ...
    parser.add_argument("--mead_root", type=str, default="/home/user/D/MEAD")
    parser.add_argument("--output_root", type=str, default="/home/user/D/generator_dataset")
    parser.add_argument("--checkpoints_dir", type=str, default="/home/user/D/speech2avatar/checkpoints")
